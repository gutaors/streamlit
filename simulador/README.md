...
DOCKER
sudo docker build -t multi-dis-pred-image:v1.0 .
daí dá um docker images, pega o código da imagem criada e cola aqui embaixo
sudo docker run -p 80:80 e3cbdfd50a2c
localhost:80
